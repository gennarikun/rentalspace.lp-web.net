...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5369"><a href="/patron"><i class="fa-solid fa-hand-holding-heart"></i> パトロン制度のご案内</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5995"><a href="/weekend-staff"><i class="fa-solid fa-utensils"></i> 猫と遊ぶとご飯無料！</a></li>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6001"><a href="https://houtoutaiken.lp-web.net/2026/02/12/web-recruit/"><i class="fa-solid fa-briefcase"></i> Webデザイナー募集</a></li>
</ul>
</nav>
</div>
